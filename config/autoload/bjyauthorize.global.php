...
return array(
    'bjyauthorize' => array(
        ...
        'role_providers' => array(
            ...
            /* here  are defined as top-level roles
             */
        ...
        'rule_providers' => array(
            'BjyAuthorize\Provider\Rule\Config' => array(
                'allow' => array(
                    ...
                    array(array('employee', 'admin', 'owner'), 'dashboard'),
					array(array('employee', 'owner'), 'report'),
					array(array('admin', 'owner'), 'configuration')
                ),

                // Don't mix allow/deny rules if you are using role inheritance.
                // There are some weird bugs.
                'deny' => array(
					array(array('admin'), 'report'),
...
///                ),
        ...
        array(
            ...
            //'roles' => array('owner', 'employee', 'admin'),
			'roles' => array('user'),
        ),
        ...
        array('controller' => 'Application\Controller\Index', 'roles' => array()),
                ...
                array(
                    'controller' => array('Dashboard\Controller\Dashboard'),
                    'roles' => array('employee', 'admin', 'owner'),
					//'roles' => array('user'),//also must be usefull
                ),
                array(
                    'controller' => array('Report\Controller\Report'),
                    'roles' => array('employee', 'owner'),
                ),
                array(
